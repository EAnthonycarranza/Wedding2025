...
const About = () => {
            ...
            <div className="col-md-8 col-md-offset-2 text-center">
              <div className="display-t">
                <div className="display-tc animate-box" data-animate-effect="fadeIn">
                  ...
                  <h2 style={{ fontFamily: "'Sacramento', cursive", fontSize: "2.5rem" }}>We Are Getting Married</h2>
  ...
  <button
    ...
    onMouseOver={(e) => {
      e.target.style.backgroundColor = "rgba(176, 0, 85, 0.7)"; // Slightly darker hover effect
      e.target.style.transform = "scale(1.05)"; // Slight scaling effect
    }}
    onMouseOut={(e) => {
      e.target.style.backgroundColor = "rgba(156, 0, 68, 0.5)"; // Revert to original translucent color
